...
Partial Class AddTaskForm
    ...
    Private Sub InitializeComponent()
        ...
        Guna2TextBox1.Font = New Font("Segoe UI Semibold", 16F, FontStyle.Bold, GraphicsUnit.Point)
        Guna2TextBox1.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        Guna2TextBox1.Location = New Point(201, 34)
        Guna2TextBox1.Margin = New Padding(10, 12, 10, 12)
        ...
        Guna2TextBox1.Size = New Size(361, 49)
        ...
        Guna2Button1.Font = New Font("Segoe UI Semibold", 15F, FontStyle.Bold, GraphicsUnit.Point)
        Guna2Button1.ForeColor = Color.White
        Guna2Button1.Location = New Point(201, 421)
        Guna2Button1.Name = "Guna2Button1"
        Guna2Button1.ShadowDecoration.CustomizableEdges = CustomizableEdges12
        Guna2Button1.Size = New Size(361, 59)
        Guna2Button1.TabIndex = 15
        Guna2Button1.Text = "ADD TASK"
        ' 
        ' Guna2Button2
        ' 
        ...
        Guna2Button2.FillColor = Color.FromArgb(CByte(250), CByte(187), CByte(24))
        Guna2Button2.Font = New Font("Segoe UI Semibold", 15F, FontStyle.Bold, GraphicsUnit.Point)
        Guna2Button2.ForeColor = Color.FromArgb(CByte(39), CByte(39), CByte(39))
        Guna2Button2.Location = New Point(201, 495)
        Guna2Button2.Name = "Guna2Button2"
        Guna2Button2.ShadowDecoration.CustomizableEdges = CustomizableEdges10
        Guna2Button2.Size = New Size(361, 59)
        ...
        Guna2ComboBox1.Font = New Font("Segoe UI Semibold", 9.75F, FontStyle.Bold, GraphicsUnit.Point)
        Guna2ComboBox1.ForeColor = Color.FromArgb(CByte(68), CByte(88), CByte(112))
        Guna2ComboBox1.ItemHeight = 30
        Guna2ComboBox1.Items.AddRange(New Object() {"Home", "School", "Fitness", "Recreation"})
        Guna2ComboBox1.Location = New Point(369, 309)
        ...
        Label1.Location = New Point(206, 315)
        Label1.Name = "Label1"
        ...
        Guna2Panel1.Size = New Size(147, 599)
        ...
        Label2.Location = New Point(251, 367)
        Label2.Name = "Label2"
        ...
        ' 
        Guna2DateTimePicker1.BorderColor = Color.FromArgb(CByte(217), CByte(221), CByte(226))
        Guna2DateTimePicker1.Checked = True
        Guna2DateTimePicker1.CustomFormat = ""
        Guna2DateTimePicker1.CustomizableEdges = CustomizableEdges3
        Guna2DateTimePicker1.FillColor = Color.White
        Guna2DateTimePicker1.Font = New Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point)
        Guna2DateTimePicker1.Format = DateTimePickerFormat.Short
        Guna2DateTimePicker1.Location = New Point(369, 361)
        ...
        Guna2DateTimePicker1.Size = New Size(193, 36)
        Guna2DateTimePicker1.TabIndex = 21
        Guna2DateTimePicker1.Value = New Date(2024, 3, 6, 14, 36, 6, 49)
        ' 
        ' Guna2TextBox2
        ' 
        Guna2TextBox2.AutoScroll = True
        Guna2TextBox2.AutoSize = True
        ...
        Guna2TextBox2.Font = New Font("Segoe UI Semibold", 14F, FontStyle.Bold, GraphicsUnit.Point)
        Guna2TextBox2.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        Guna2TextBox2.Location = New Point(201, 99)
        Guna2TextBox2.Margin = New Padding(16, 20, 16, 20)
